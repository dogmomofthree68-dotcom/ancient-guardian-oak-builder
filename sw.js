const CACHE = "oak-builder-v21-layer13";
const FILES = ["./", "index.html", "styles.css?v=21-layer13", "app.js?v=21-layer13", "manifest.webmanifest", "icons/icon-192.png", "icons/icon-512.png"];
