const CACHE = "oak-builder-v21-layer9";
const FILES = ["./", "index.html", "styles.css?v=21-layer9", "app.js?v=21-layer9", "manifest.webmanifest", "icons/icon-192.png", "icons/icon-512.png"];
