const CACHE = "oak-builder-v21-layer17";
const FILES = ["./", "index.html", "styles.css?v=21-layer17", "app.js?v=21-layer17", "manifest.webmanifest", "icons/icon-192.png", "icons/icon-512.png"];
