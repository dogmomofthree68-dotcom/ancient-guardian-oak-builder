const CACHE = "oak-builder-v21-layer12";
const FILES = ["./", "index.html", "styles.css?v=21-layer12", "app.js?v=21-layer12", "manifest.webmanifest", "icons/icon-192.png", "icons/icon-512.png"];
