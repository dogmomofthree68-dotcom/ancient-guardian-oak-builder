const CACHE = "oak-builder-v21-layer11-fixed2";
const FILES = ["./", "index.html", "styles.css?v=21-layer11-fixed2", "app.js?v=21-layer11-fixed2", "manifest.webmanifest", "icons/icon-192.png", "icons/icon-512.png"];
