const CACHE = "oak-builder-v21-layer10";
const FILES = ["./", "index.html", "styles.css?v=21-layer10", "app.js?v=21-layer10", "manifest.webmanifest", "icons/icon-192.png", "icons/icon-512.png"];
